    ...
    <section className={styles.section} id="solution" ref={ref}>
      <div className="container">
        ...
        <p className="section-subtitle">
          Российская лабораторная система водоочистки IPSAR для получения воды I и II типа осуществляет автоматический контроль качества воды, отслеживает ресурс картриджей, проводит самодиагностику и уведомляет о необходимости проведения ремонта, технического обслуживания или замены фильтрующих элементов.
        </p>
