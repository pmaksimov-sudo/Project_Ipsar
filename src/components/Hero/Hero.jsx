      ...
      <div className={`container ${styles.inner}`}>
        <div className={styles.content}>
          ...
          <h1 className={`hero-animate ${styles.title}`}>
            Универсальная лабораторная система очистки воды экспертного класса IPSAR — вода тип&nbsp;I и тип&nbsp;II
          </h1>

          <p className={`hero-animate ${styles.subtitle}`}>
            Получение сверхчистой воды для научно-исследовательских и клинико-диагностических лабораторий любых направлений. Автоматизированная система. Полное сервисное сопровождение 24/7.
          </p>
